...
interface ErrorViewProps {
   ...
   * router (e.g. app/[locale]/error.tsx). Defaults to a raw `<a>`, which is required
...
/**
 * Shared error boundary view used by both app/[locale]/error.tsx and app/global-error.tsx.
 *
