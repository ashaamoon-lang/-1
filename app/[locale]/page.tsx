      ...
      <main>
        ...
        <section className={s.section}>
          ...
          <p className={s.body}>
            ...
            across the industry. Starting there means starting from the same
            line as the studios doing this work professionally, under the MIT
            licence, rather than assembling a stack from tutorials.
          </p>
          <p className={s.body}>
          ...
          <p className={s.body}>
            The most useful finding was that the easing curves these studios
            ship are already named tokens in this codebase. The curve used most
            heavily on one measured site is exactly the token defined here as
            ...
            consistently, is what separates these sites from competent ones —
            two typefaces, three weights, one accent colour, a handful of
            durations, chosen once and never violated.
          </p>
          <p className={s.body}>
            Seven of the ten sites ship no reduced-motion handling in their CSS
            at all. That gap is treated here as an opportunity rather than a
            precedent: every component in this repository honours the
            preference, and does so without leaving content stranded invisible
