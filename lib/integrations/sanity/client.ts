...
//    app/(chrome)/cms/layout.tsx — noindex passthrough only (robots metadata);
...
//
// Full walkthrough: see the manual (app/[locale]/page.tsx) step 5 "Add a plugin".
